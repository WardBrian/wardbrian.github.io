...
some links to fix broken ones jsdoc2md generates. My kingdom for a consistent
rule of how markdown section headers get turned into html headers.
...
called `roxygen2`, which processes comments in the source code. Of course, roxygen2 is
...
Unlike the others (though [spoilers!] like Rust), I don't try to get the top-level
